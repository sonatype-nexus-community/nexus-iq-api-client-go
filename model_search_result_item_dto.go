...
type SearchResultItemDTO struct {
	...
	ComponentEffectiveLicenseId *string `json:"componentEffectiveLicenseId,omitempty"`
	ComponentEffectiveLicenseName *string `json:"componentEffectiveLicenseName,omitempty"`
	...
	ComponentLicenseThreatGroupName *string `json:"componentLicenseThreatGroupName,omitempty"`
	ComponentLicenseThreatLevel *int32 `json:"componentLicenseThreatLevel,omitempty"`
	...
	PolicyViolationConstraintName *string `json:"policyViolationConstraintName,omitempty"`
	PolicyViolationId *string `json:"policyViolationId,omitempty"`
	PolicyViolationPolicyId *string `json:"policyViolationPolicyId,omitempty"`
	PolicyViolationPolicyName *string `json:"policyViolationPolicyName,omitempty"`
	PolicyViolationThreatCategory *string `json:"policyViolationThreatCategory,omitempty"`
	PolicyViolationThreatLevel *int32 `json:"policyViolationThreatLevel,omitempty"`
	PolicyViolationWaiverStatus *string `json:"policyViolationWaiverStatus,omitempty"`
...
// GetComponentEffectiveLicenseId returns the ComponentEffectiveLicenseId field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetComponentEffectiveLicenseId() string {
	if o == nil || IsNil(o.ComponentEffectiveLicenseId) {
		var ret string
		return ret
	}
	return *o.ComponentEffectiveLicenseId
}

// GetComponentEffectiveLicenseIdOk returns a tuple with the ComponentEffectiveLicenseId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetComponentEffectiveLicenseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ComponentEffectiveLicenseId) {
		return nil, false
	}
	return o.ComponentEffectiveLicenseId, true
}
...
// SetComponentEffectiveLicenseId gets a reference to the given string and assigns it to the ComponentEffectiveLicenseId field.
func (o *SearchResultItemDTO) SetComponentEffectiveLicenseId(v string) {
	o.ComponentEffectiveLicenseId = &v
}

// GetComponentEffectiveLicenseName returns the ComponentEffectiveLicenseName field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetComponentEffectiveLicenseName() string {
	if o == nil || IsNil(o.ComponentEffectiveLicenseName) {
		var ret string
		return ret
	}
	return *o.ComponentEffectiveLicenseName
}

// GetComponentEffectiveLicenseNameOk returns a tuple with the ComponentEffectiveLicenseName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetComponentEffectiveLicenseNameOk() (*string, bool) {
	if o == nil || IsNil(o.ComponentEffectiveLicenseName) {
		return nil, false
	}
	return o.ComponentEffectiveLicenseName, true
}
...
// SetComponentEffectiveLicenseName gets a reference to the given string and assigns it to the ComponentEffectiveLicenseName field.
func (o *SearchResultItemDTO) SetComponentEffectiveLicenseName(v string) {
	o.ComponentEffectiveLicenseName = &v
}
...
// GetComponentLicenseThreatGroupName returns the ComponentLicenseThreatGroupName field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetComponentLicenseThreatGroupName() string {
	if o == nil || IsNil(o.ComponentLicenseThreatGroupName) {
		var ret string
		return ret
	}
	return *o.ComponentLicenseThreatGroupName
}

// GetComponentLicenseThreatGroupNameOk returns a tuple with the ComponentLicenseThreatGroupName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetComponentLicenseThreatGroupNameOk() (*string, bool) {
	if o == nil || IsNil(o.ComponentLicenseThreatGroupName) {
		return nil, false
	}
	return o.ComponentLicenseThreatGroupName, true
}
...
// SetComponentLicenseThreatGroupName gets a reference to the given string and assigns it to the ComponentLicenseThreatGroupName field.
func (o *SearchResultItemDTO) SetComponentLicenseThreatGroupName(v string) {
	o.ComponentLicenseThreatGroupName = &v
}

// GetComponentLicenseThreatLevel returns the ComponentLicenseThreatLevel field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetComponentLicenseThreatLevel() int32 {
	if o == nil || IsNil(o.ComponentLicenseThreatLevel) {
		var ret int32
		return ret
	}
	return *o.ComponentLicenseThreatLevel
}

// GetComponentLicenseThreatLevelOk returns a tuple with the ComponentLicenseThreatLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetComponentLicenseThreatLevelOk() (*int32, bool) {
	if o == nil || IsNil(o.ComponentLicenseThreatLevel) {
		return nil, false
	}
	return o.ComponentLicenseThreatLevel, true
}
...
// SetComponentLicenseThreatLevel gets a reference to the given int32 and assigns it to the ComponentLicenseThreatLevel field.
func (o *SearchResultItemDTO) SetComponentLicenseThreatLevel(v int32) {
	o.ComponentLicenseThreatLevel = &v
}
...
// GetPolicyViolationConstraintName returns the PolicyViolationConstraintName field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationConstraintName() string {
	if o == nil || IsNil(o.PolicyViolationConstraintName) {
		var ret string
		return ret
	}
	return *o.PolicyViolationConstraintName
}

// GetPolicyViolationConstraintNameOk returns a tuple with the PolicyViolationConstraintName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationConstraintNameOk() (*string, bool) {
	if o == nil || IsNil(o.PolicyViolationConstraintName) {
		return nil, false
	}
	return o.PolicyViolationConstraintName, true
}
...
// SetPolicyViolationConstraintName gets a reference to the given string and assigns it to the PolicyViolationConstraintName field.
func (o *SearchResultItemDTO) SetPolicyViolationConstraintName(v string) {
	o.PolicyViolationConstraintName = &v
}
...
// GetPolicyViolationPolicyId returns the PolicyViolationPolicyId field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationPolicyId() string {
	if o == nil || IsNil(o.PolicyViolationPolicyId) {
		var ret string
		return ret
	}
	return *o.PolicyViolationPolicyId
}

// GetPolicyViolationPolicyIdOk returns a tuple with the PolicyViolationPolicyId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationPolicyIdOk() (*string, bool) {
	if o == nil || IsNil(o.PolicyViolationPolicyId) {
		return nil, false
	}
	return o.PolicyViolationPolicyId, true
}
...
// SetPolicyViolationPolicyId gets a reference to the given string and assigns it to the PolicyViolationPolicyId field.
func (o *SearchResultItemDTO) SetPolicyViolationPolicyId(v string) {
	o.PolicyViolationPolicyId = &v
}

// GetPolicyViolationPolicyName returns the PolicyViolationPolicyName field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationPolicyName() string {
	if o == nil || IsNil(o.PolicyViolationPolicyName) {
		var ret string
		return ret
	}
	return *o.PolicyViolationPolicyName
}

// GetPolicyViolationPolicyNameOk returns a tuple with the PolicyViolationPolicyName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationPolicyNameOk() (*string, bool) {
	if o == nil || IsNil(o.PolicyViolationPolicyName) {
		return nil, false
	}
	return o.PolicyViolationPolicyName, true
}
...
// SetPolicyViolationPolicyName gets a reference to the given string and assigns it to the PolicyViolationPolicyName field.
func (o *SearchResultItemDTO) SetPolicyViolationPolicyName(v string) {
	o.PolicyViolationPolicyName = &v
}

// GetPolicyViolationThreatCategory returns the PolicyViolationThreatCategory field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationThreatCategory() string {
	if o == nil || IsNil(o.PolicyViolationThreatCategory) {
		var ret string
		return ret
	}
	return *o.PolicyViolationThreatCategory
}

// GetPolicyViolationThreatCategoryOk returns a tuple with the PolicyViolationThreatCategory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationThreatCategoryOk() (*string, bool) {
	if o == nil || IsNil(o.PolicyViolationThreatCategory) {
		return nil, false
	}
	return o.PolicyViolationThreatCategory, true
}
...
// SetPolicyViolationThreatCategory gets a reference to the given string and assigns it to the PolicyViolationThreatCategory field.
func (o *SearchResultItemDTO) SetPolicyViolationThreatCategory(v string) {
	o.PolicyViolationThreatCategory = &v
}

// GetPolicyViolationThreatLevel returns the PolicyViolationThreatLevel field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationThreatLevel() int32 {
	if o == nil || IsNil(o.PolicyViolationThreatLevel) {
		var ret int32
		return ret
	}
	return *o.PolicyViolationThreatLevel
}

// GetPolicyViolationThreatLevelOk returns a tuple with the PolicyViolationThreatLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationThreatLevelOk() (*int32, bool) {
	if o == nil || IsNil(o.PolicyViolationThreatLevel) {
		return nil, false
	}
	return o.PolicyViolationThreatLevel, true
}
...
// SetPolicyViolationThreatLevel gets a reference to the given int32 and assigns it to the PolicyViolationThreatLevel field.
func (o *SearchResultItemDTO) SetPolicyViolationThreatLevel(v int32) {
	o.PolicyViolationThreatLevel = &v
}

// GetPolicyViolationWaiverStatus returns the PolicyViolationWaiverStatus field value if set, zero value otherwise.
func (o *SearchResultItemDTO) GetPolicyViolationWaiverStatus() string {
	if o == nil || IsNil(o.PolicyViolationWaiverStatus) {
		var ret string
		return ret
	}
	return *o.PolicyViolationWaiverStatus
}

// GetPolicyViolationWaiverStatusOk returns a tuple with the PolicyViolationWaiverStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResultItemDTO) GetPolicyViolationWaiverStatusOk() (*string, bool) {
	if o == nil || IsNil(o.PolicyViolationWaiverStatus) {
		return nil, false
	}
	return o.PolicyViolationWaiverStatus, true
}
...
// SetPolicyViolationWaiverStatus gets a reference to the given string and assigns it to the PolicyViolationWaiverStatus field.
func (o *SearchResultItemDTO) SetPolicyViolationWaiverStatus(v string) {
	o.PolicyViolationWaiverStatus = &v
}
...
func (o SearchResultItemDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ComponentEffectiveLicenseId) {
		toSerialize["componentEffectiveLicenseId"] = o.ComponentEffectiveLicenseId
	}
	if !IsNil(o.ComponentEffectiveLicenseName) {
		toSerialize["componentEffectiveLicenseName"] = o.ComponentEffectiveLicenseName
	}
	...
	if !IsNil(o.ComponentLicenseThreatGroupName) {
		toSerialize["componentLicenseThreatGroupName"] = o.ComponentLicenseThreatGroupName
	}
	if !IsNil(o.ComponentLicenseThreatLevel) {
		toSerialize["componentLicenseThreatLevel"] = o.ComponentLicenseThreatLevel
	}
	...
	if !IsNil(o.PolicyViolationConstraintName) {
		toSerialize["policyViolationConstraintName"] = o.PolicyViolationConstraintName
	}
	if !IsNil(o.PolicyViolationId) {
		toSerialize["policyViolationId"] = o.PolicyViolationId
	}
	if !IsNil(o.PolicyViolationPolicyId) {
		toSerialize["policyViolationPolicyId"] = o.PolicyViolationPolicyId
	}
	if !IsNil(o.PolicyViolationPolicyName) {
		toSerialize["policyViolationPolicyName"] = o.PolicyViolationPolicyName
	}
	if !IsNil(o.PolicyViolationThreatCategory) {
		toSerialize["policyViolationThreatCategory"] = o.PolicyViolationThreatCategory
	}
	if !IsNil(o.PolicyViolationThreatLevel) {
		toSerialize["policyViolationThreatLevel"] = o.PolicyViolationThreatLevel
	}
	if !IsNil(o.PolicyViolationWaiverStatus) {
		toSerialize["policyViolationWaiverStatus"] = o.PolicyViolationWaiverStatus
	}
	if !IsNil(o.ReportId) {
