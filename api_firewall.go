...
func (r ApiGetFirewallMetricsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *FirewallAPIService) GetFirewallMetricsExecute(r ApiGetFirewallMetricsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
