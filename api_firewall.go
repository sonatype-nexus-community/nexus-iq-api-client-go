...
func (r ApiEvaluateComponentsRequest) ApiRepositoryComponentEvaluationRequestList(apiRepositoryComponentEvaluationRequestList ApiRepositoryComponentEvaluationRequestList) ApiEvaluateComponentsRequest {
	r.apiRepositoryComponentEvaluationRequestList = &apiRepositoryComponentEvaluationRequestList
	return r
}

func (r ApiEvaluateComponentsRequest) Execute() (*ApiRepositoryComponentEvaluationResultList, *http.Response, error) {
...
*/
func (a *FirewallAPIService) EvaluateComponents(ctx context.Context, repositoryManagerId string, repositoryId string) ApiEvaluateComponentsRequest {
	return ApiEvaluateComponentsRequest{
		ApiService: a,
		ctx: ctx,
		repositoryManagerId: repositoryManagerId,
...
func (a *FirewallAPIService) EvaluateComponentsExecute(r ApiEvaluateComponentsRequest) (*ApiRepositoryComponentEvaluationResultList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirewallAPIService.EvaluateComponents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *FirewallAPIService) GetQuarantineListExecute(r ApiGetQuarantineListRequest) (*http.Response, error) {
	...
	if r.policyId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "policyId", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "policyId", t, "multi")
		}
	}
