...
type ApiCompositeSourceControlDTO struct {
	...
	GithubApp *ApiCompositeValueDTOGitHubAppInfo `json:"githubApp,omitempty"`
...
// SetGithubApp gets a reference to the given ApiCompositeValueDTOGitHubAppInfo and assigns it to the GithubApp field.
