...
type ApiCompositeSourceControlDTO struct {
	AuthenticationType *ApiCompositeValueDTOString `json:"authenticationType,omitempty"`
	BaseBranch *ApiCompositeValueDTOString `json:"baseBranch,omitempty"`
	ClosePrAfterDays *ApiCompositeValueDTOInteger `json:"closePrAfterDays,omitempty"`
	ClosePrAfterDaysOpenEnabled *ApiCompositeValueDTOBoolean `json:"closePrAfterDaysOpenEnabled,omitempty"`
	ClosePrOnFailedChecksEnabled *ApiCompositeValueDTOBoolean `json:"closePrOnFailedChecksEnabled,omitempty"`
	CommitStatusEnabled *ApiCompositeValueDTOBoolean `json:"commitStatusEnabled,omitempty"`
	GithubApps []ApiCompositeValueDTOGitHubAppInfo `json:"githubApps,omitempty"`
	...
	NonGoldenPullRequestsEnabled *ApiCompositeValueDTOBoolean `json:"nonGoldenPullRequestsEnabled,omitempty"`
...
// SetAuthenticationType gets a reference to the given ApiCompositeValueDTOString and assigns it to the AuthenticationType field.
...
func (o *ApiCompositeSourceControlDTO) GetClosePrAfterDays() ApiCompositeValueDTOInteger {
	if o == nil || IsNil(o.ClosePrAfterDays) {
		var ret ApiCompositeValueDTOInteger
		return ret
	}
...
// SetClosePrAfterDays gets a reference to the given ApiCompositeValueDTOInteger and assigns it to the ClosePrAfterDays field.
...
// SetClosePrAfterDaysOpenEnabled gets a reference to the given ApiCompositeValueDTOBoolean and assigns it to the ClosePrAfterDaysOpenEnabled field.
...
// SetClosePrOnFailedChecksEnabled gets a reference to the given ApiCompositeValueDTOBoolean and assigns it to the ClosePrOnFailedChecksEnabled field.
...
// GetGithubApps returns the GithubApps field value if set, zero value otherwise.
func (o *ApiCompositeSourceControlDTO) GetGithubApps() []ApiCompositeValueDTOGitHubAppInfo {
	if o == nil || IsNil(o.GithubApps) {
		var ret []ApiCompositeValueDTOGitHubAppInfo
		return ret
	}
	return o.GithubApps
}

// GetGithubAppsOk returns a tuple with the GithubApps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiCompositeSourceControlDTO) GetGithubAppsOk() ([]ApiCompositeValueDTOGitHubAppInfo, bool) {
	if o == nil || IsNil(o.GithubApps) {
		return nil, false
	}
	return o.GithubApps, true
}
...
// SetGithubApps gets a reference to the given []ApiCompositeValueDTOGitHubAppInfo and assigns it to the GithubApps field.
...
// GetNonGoldenPullRequestsEnabled returns the NonGoldenPullRequestsEnabled field value if set, zero value otherwise.
func (o *ApiCompositeSourceControlDTO) GetNonGoldenPullRequestsEnabled() ApiCompositeValueDTOBoolean {
	if o == nil || IsNil(o.NonGoldenPullRequestsEnabled) {
		var ret ApiCompositeValueDTOBoolean
		return ret
	}
	return *o.NonGoldenPullRequestsEnabled
}

// GetNonGoldenPullRequestsEnabledOk returns a tuple with the NonGoldenPullRequestsEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiCompositeSourceControlDTO) GetNonGoldenPullRequestsEnabledOk() (*ApiCompositeValueDTOBoolean, bool) {
	if o == nil || IsNil(o.NonGoldenPullRequestsEnabled) {
		return nil, false
	}
	return o.NonGoldenPullRequestsEnabled, true
}
...
// SetNonGoldenPullRequestsEnabled gets a reference to the given ApiCompositeValueDTOBoolean and assigns it to the NonGoldenPullRequestsEnabled field.
func (o *ApiCompositeSourceControlDTO) SetNonGoldenPullRequestsEnabled(v ApiCompositeValueDTOBoolean) {
	o.NonGoldenPullRequestsEnabled = &v
}
...
func (o ApiCompositeSourceControlDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GithubApps) {
		toSerialize["githubApps"] = o.GithubApps
	}
	if !IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
	...
	if !IsNil(o.NonGoldenPullRequestsEnabled) {
		toSerialize["nonGoldenPullRequestsEnabled"] = o.NonGoldenPullRequestsEnabled
	}
	if !IsNil(o.OwnerId) {
