...
Use this method to grant a role to a user or user group for the specified application, organization, repository manager, or repository.
...
Use this method to revoke a role from a user or user group, on a specific application, organization, repository manager, or repository.
