...
type ApiAddOrUpdateSourceControlRequest struct {
	ctx context.Context
...
func (r ApiAddOrUpdateSourceControlRequest) PublicId(publicId string) ApiAddOrUpdateSourceControlRequest {
	r.publicId = &publicId
	return r
}

func (r ApiAddOrUpdateSourceControlRequest) RepositoryUrl(repositoryUrl string) ApiAddOrUpdateSourceControlRequest {
	r.repositoryUrl = &repositoryUrl
	return r
}

func (r ApiAddOrUpdateSourceControlRequest) Execute() (*ApiSourceControlDTO, *http.Response, error) {
	return r.ApiService.AddOrUpdateSourceControlExecute(r)
}

/*
AddOrUpdateSourceControl Method for AddOrUpdateSourceControl

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiAddOrUpdateSourceControlRequest
*/
func (a *SourceControlAPIService) AddOrUpdateSourceControl(ctx context.Context) ApiAddOrUpdateSourceControlRequest {
	return ApiAddOrUpdateSourceControlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SourceControlAPIService) AddOrUpdateSourceControlExecute(r ApiAddOrUpdateSourceControlRequest) (*ApiSourceControlDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.AddOrUpdateSourceControl")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl"
	...
	if r.publicId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "publicId", r.publicId, "")
	}
