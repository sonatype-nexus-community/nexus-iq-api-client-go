...
type ApiDeregisterFromRelayRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiDeregisterFromRelayRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeregisterFromRelayExecute(r)
}

/*
DeregisterFromRelay Method for DeregisterFromRelay

Deregister this IQ Server from the SCM webhook relay. Drops the local relay_configuration row and asks the relay to delete the customer record (SQS queue + DynamoDB row). Required before switching auth modes (PAT ↔ GitHub App) since the relay rejects cross-mode switching of an existing customer.

Permissions required: System Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeregisterFromRelayRequest
*/
func (a *SourceControlAPIService) DeregisterFromRelay(ctx context.Context) ApiDeregisterFromRelayRequest {
	return ApiDeregisterFromRelayRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) DeregisterFromRelayExecute(r ApiDeregisterFromRelayRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.DeregisterFromRelay")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relay/deregister"
...
type ApiGetGitHubAppWebhookUrlRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiGetGitHubAppWebhookUrlRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetGitHubAppWebhookUrlExecute(r)
}

/*
GetGitHubAppWebhookUrl Method for GetGitHubAppWebhookUrl

Returns the App-level webhook URL the customer must paste into the GitHub App configuration. Same value for every customer; available before any registration exists because the URL is needed when creating the App.

Permissions required: Manage Automatic SCM Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetGitHubAppWebhookUrlRequest
*/
func (a *SourceControlAPIService) GetGitHubAppWebhookUrl(ctx context.Context) ApiGetGitHubAppWebhookUrlRequest {
	return ApiGetGitHubAppWebhookUrlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) GetGitHubAppWebhookUrlExecute(r ApiGetGitHubAppWebhookUrlRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.GetGitHubAppWebhookUrl")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/githubAppWebhookUrl"
...
type ApiGetRelayWebhookSecretRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiGetRelayWebhookSecretRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetRelayWebhookSecretExecute(r)
}

/*
GetRelayWebhookSecret Method for GetRelayWebhookSecret

Returns the per-customer HMAC signing secret used to verify webhook deliveries from the SCM provider, when a PAT-mode relay registration exists. GitHub App registrations have no per-customer secret and return 404. 

Permissions required: Manage Automatic SCM Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRelayWebhookSecretRequest
*/
func (a *SourceControlAPIService) GetRelayWebhookSecret(ctx context.Context) ApiGetRelayWebhookSecretRequest {
	return ApiGetRelayWebhookSecretRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) GetRelayWebhookSecretExecute(r ApiGetRelayWebhookSecretRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.GetRelayWebhookSecret")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relayWebhookSecret"
...
type ApiGetRelayWebhookUrlRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiGetRelayWebhookUrlRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetRelayWebhookUrlExecute(r)
}

/*
GetRelayWebhookUrl Method for GetRelayWebhookUrl

Returns the SCM webhook URL the IQ Server is registered against, when the relay integration is enabled and registered. 

Permissions required: Manage Automatic SCM Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRelayWebhookUrlRequest
*/
func (a *SourceControlAPIService) GetRelayWebhookUrl(ctx context.Context) ApiGetRelayWebhookUrlRequest {
	return ApiGetRelayWebhookUrlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) GetRelayWebhookUrlExecute(r ApiGetRelayWebhookUrlRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.GetRelayWebhookUrl")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relayWebhookUrl"
...
type ApiRegisterWithRelayRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
	relayRegisterAdminRequest *RelayRegisterAdminRequest
}

func (r ApiRegisterWithRelayRequest) RelayRegisterAdminRequest(relayRegisterAdminRequest RelayRegisterAdminRequest) ApiRegisterWithRelayRequest {
	r.relayRegisterAdminRequest = &relayRegisterAdminRequest
	return r
}

func (r ApiRegisterWithRelayRequest) Execute() (*http.Response, error) {
	return r.ApiService.RegisterWithRelayExecute(r)
}

/*
RegisterWithRelay Method for RegisterWithRelay

Re-register this IQ Server with the SCM webhook relay. An optional JSON body with installationId and webhookSecret routes the call to the GitHub App registration path; an empty/missing body uses the PAT path.

Permissions required: System Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRegisterWithRelayRequest
*/
func (a *SourceControlAPIService) RegisterWithRelay(ctx context.Context) ApiRegisterWithRelayRequest {
	return ApiRegisterWithRelayRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) RegisterWithRelayExecute(r ApiRegisterWithRelayRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.RegisterWithRelay")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relay/register"
	...
	// body params
	localVarPostBody = r.relayRegisterAdminRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiRotateRelayApiKeyRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiRotateRelayApiKeyRequest) Execute() (*http.Response, error) {
	return r.ApiService.RotateRelayApiKeyExecute(r)
}

/*
RotateRelayApiKey Method for RotateRelayApiKey

Rotate the IQ→relay API key. The relay generates a fresh key and keeps the previous key valid for a 5-minute grace window so in-flight polls do not fail. The new plaintext is returned exactly once.

Permissions required: System Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRotateRelayApiKeyRequest
*/
func (a *SourceControlAPIService) RotateRelayApiKey(ctx context.Context) ApiRotateRelayApiKeyRequest {
	return ApiRotateRelayApiKeyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) RotateRelayApiKeyExecute(r ApiRotateRelayApiKeyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.RotateRelayApiKey")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relay/rotate-key"
...
type ApiRotateRelayWebhookSecretRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiRotateRelayWebhookSecretRequest) Execute() (*http.Response, error) {
	return r.ApiService.RotateRelayWebhookSecretExecute(r)
}

/*
RotateRelayWebhookSecret Method for RotateRelayWebhookSecret

Rotate the per-customer PAT webhook signing secret. The relay accepts both old and new signatures during a 5-minute grace window so the SCM provider's webhook configuration can be updated without dropping deliveries. The new plaintext is returned exactly once — paste it into the SCM provider's webhook secret field.

Permissions required: System Configuration.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRotateRelayWebhookSecretRequest
*/
func (a *SourceControlAPIService) RotateRelayWebhookSecret(ctx context.Context) ApiRotateRelayWebhookSecretRequest {
	return ApiRotateRelayWebhookSecretRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SourceControlAPIService) RotateRelayWebhookSecretExecute(r ApiRotateRelayWebhookSecretRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.RotateRelayWebhookSecret")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sourceControl/relay/rotate-webhook-secret"
