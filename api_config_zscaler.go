...
func (r ApiGetConfiguration7Request) Execute() (*ApiZScalerConfigurationDTO, *http.Response, error) {
...
*/
func (a *ConfigZscalerAPIService) GetConfiguration7(ctx context.Context) ApiGetConfiguration7Request {
	return ApiGetConfiguration7Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigZscalerAPIService) GetConfiguration7Execute(r ApiGetConfiguration7Request) (*ApiZScalerConfigurationDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigZscalerAPIService.GetConfiguration7")
	if err != nil {
