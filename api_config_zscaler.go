...
type ApiDeleteConfiguration8Request struct {
	ctx context.Context
	ApiService *ConfigZscalerAPIService
}

func (r ApiDeleteConfiguration8Request) Execute() (*http.Response, error) {
	return r.ApiService.DeleteConfiguration8Execute(r)
}

/*
DeleteConfiguration8 Method for DeleteConfiguration8
...
Permissions required: Edit System Configuration and Users
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteConfiguration8Request
*/
func (a *ConfigZscalerAPIService) DeleteConfiguration8(ctx context.Context) ApiDeleteConfiguration8Request {
	return ApiDeleteConfiguration8Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ConfigZscalerAPIService) DeleteConfiguration8Execute(r ApiDeleteConfiguration8Request) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigZscalerAPIService.DeleteConfiguration8")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetConfiguration9Request struct {
	ctx context.Context
	ApiService *ConfigZscalerAPIService
}

func (r ApiGetConfiguration9Request) Execute() (*ApiZScalerConfigurationDTO, *http.Response, error) {
	return r.ApiService.GetConfiguration9Execute(r)
}

/*
GetConfiguration9 Method for GetConfiguration9
...
Permissions required: Edit System Configuration and Users
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetConfiguration9Request
*/
func (a *ConfigZscalerAPIService) GetConfiguration9(ctx context.Context) ApiGetConfiguration9Request {
	return ApiGetConfiguration9Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigZscalerAPIService) GetConfiguration9Execute(r ApiGetConfiguration9Request) (*ApiZScalerConfigurationDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigZscalerAPIService.GetConfiguration9")
	if err != nil {
