...
func (r ApiUploadScanRequest) Client(client string) ApiUploadScanRequest {
	r.client = &client
	return r
}
...
func (r ApiUploadScanRequest) CorrelationId(correlationId string) ApiUploadScanRequest {
	r.correlationId = &correlationId
	return r
}

func (r ApiUploadScanRequest) EvaluationMode(evaluationMode string) ApiUploadScanRequest {
	r.evaluationMode = &evaluationMode
	return r
}
...
func (r ApiUploadScanRequest) RequestedBy(requestedBy string) ApiUploadScanRequest {
...
func (a *RepositoriesAPIService) UploadScanExecute(r ApiUploadScanRequest) (*http.Response, error) {
	...
	if r.client != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "client", r.client, "", "")
	}
	if r.componentId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "componentId", r.componentId, "", "")
	}
	if r.correlationId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "correlationId", r.correlationId, "", "")
	}
	if r.evaluationMode != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "evaluationMode", r.evaluationMode, "", "")
	}
	...
	if r.requestedBy != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "requestedBy", r.requestedBy, "", "")
	}
