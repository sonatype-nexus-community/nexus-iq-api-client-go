...
type ApiSourceControlConfigurationDTO struct {
	...
	GpgSigningKey *string `json:"gpgSigningKey,omitempty"`
...
// GetGpgSigningKey returns the GpgSigningKey field value if set, zero value otherwise.
func (o *ApiSourceControlConfigurationDTO) GetGpgSigningKey() string {
	if o == nil || IsNil(o.GpgSigningKey) {
		var ret string
		return ret
	}
	return *o.GpgSigningKey
}

// GetGpgSigningKeyOk returns a tuple with the GpgSigningKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiSourceControlConfigurationDTO) GetGpgSigningKeyOk() (*string, bool) {
	if o == nil || IsNil(o.GpgSigningKey) {
		return nil, false
	}
	return o.GpgSigningKey, true
}
...
// SetGpgSigningKey gets a reference to the given string and assigns it to the GpgSigningKey field.
...
func (o ApiSourceControlConfigurationDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GpgPassphrase) {
		toSerialize["gpgPassphrase"] = o.GpgPassphrase
	}
	if !IsNil(o.GpgSigningKey) {
		toSerialize["gpgSigningKey"] = o.GpgSigningKey
	}
