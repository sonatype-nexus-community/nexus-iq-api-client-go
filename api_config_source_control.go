...
*/
func (a *ConfigSourceControlAPIService) DeleteConfiguration6(ctx context.Context) ApiDeleteConfiguration6Request {
	return ApiDeleteConfiguration6Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigSourceControlAPIService) DeleteConfiguration6Execute(r ApiDeleteConfiguration6Request) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSourceControlAPIService.DeleteConfiguration6")
	if err != nil {
...
func (r ApiGetConfiguration6Request) Execute() (*ApiSourceControlConfigurationDTO, *http.Response, error) {
...
*/
func (a *ConfigSourceControlAPIService) GetConfiguration6(ctx context.Context) ApiGetConfiguration6Request {
	return ApiGetConfiguration6Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigSourceControlAPIService) GetConfiguration6Execute(r ApiGetConfiguration6Request) (*ApiSourceControlConfigurationDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSourceControlAPIService.GetConfiguration6")
	if err != nil {
