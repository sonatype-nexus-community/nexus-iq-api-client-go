...
*/
func (a *ConfigSourceControlAPIService) DeleteConfiguration7(ctx context.Context) ApiDeleteConfiguration7Request {
	return ApiDeleteConfiguration7Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigSourceControlAPIService) DeleteConfiguration7Execute(r ApiDeleteConfiguration7Request) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSourceControlAPIService.DeleteConfiguration7")
	if err != nil {
...
func (r ApiGetConfiguration7Request) Execute() (*ApiSourceControlConfigurationDTO, *http.Response, error) {
...
*/
func (a *ConfigSourceControlAPIService) GetConfiguration7(ctx context.Context) ApiGetConfiguration7Request {
	return ApiGetConfiguration7Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ConfigSourceControlAPIService) GetConfiguration7Execute(r ApiGetConfiguration7Request) (*ApiSourceControlConfigurationDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSourceControlAPIService.GetConfiguration7")
	if err != nil {
...
func (r ApiSetConfiguration6Request) ApiSourceControlConfigurationDTO(apiSourceControlConfigurationDTO ApiSourceControlConfigurationDTO) ApiSetConfiguration6Request {
	r.apiSourceControlConfigurationDTO = &apiSourceControlConfigurationDTO
	return r
}

func (r ApiSetConfiguration6Request) Execute() (*http.Response, error) {
...
*/
func (a *ConfigSourceControlAPIService) SetConfiguration6(ctx context.Context) ApiSetConfiguration6Request {
	return ApiSetConfiguration6Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ConfigSourceControlAPIService) SetConfiguration6Execute(r ApiSetConfiguration6Request) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSourceControlAPIService.SetConfiguration6")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
