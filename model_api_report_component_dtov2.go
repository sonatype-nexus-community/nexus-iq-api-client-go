...
type ApiReportComponentDTOV2 struct {
	AiModelData *ApiAiModelDataDTO `json:"aiModelData,omitempty"`
	...
	OriginalPurl *string `json:"originalPurl,omitempty"`
...
// GetAiModelData returns the AiModelData field value if set, zero value otherwise.
func (o *ApiReportComponentDTOV2) GetAiModelData() ApiAiModelDataDTO {
	if o == nil || IsNil(o.AiModelData) {
		var ret ApiAiModelDataDTO
		return ret
	}
	return *o.AiModelData
}

// GetAiModelDataOk returns a tuple with the AiModelData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiReportComponentDTOV2) GetAiModelDataOk() (*ApiAiModelDataDTO, bool) {
	if o == nil || IsNil(o.AiModelData) {
		return nil, false
	}
	return o.AiModelData, true
}
...
// SetAiModelData gets a reference to the given ApiAiModelDataDTO and assigns it to the AiModelData field.
...
// GetOriginalPurl returns the OriginalPurl field value if set, zero value otherwise.
func (o *ApiReportComponentDTOV2) GetOriginalPurl() string {
	if o == nil || IsNil(o.OriginalPurl) {
		var ret string
		return ret
	}
	return *o.OriginalPurl
}

// GetOriginalPurlOk returns a tuple with the OriginalPurl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiReportComponentDTOV2) GetOriginalPurlOk() (*string, bool) {
	if o == nil || IsNil(o.OriginalPurl) {
		return nil, false
	}
	return o.OriginalPurl, true
}
...
// SetOriginalPurl gets a reference to the given string and assigns it to the OriginalPurl field.
...
func (o ApiReportComponentDTOV2) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AiModelData) {
		toSerialize["aiModelData"] = o.AiModelData
	}
	...
	if !IsNil(o.OriginalPurl) {
		toSerialize["originalPurl"] = o.OriginalPurl
	}
