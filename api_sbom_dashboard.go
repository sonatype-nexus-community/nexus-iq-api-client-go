...
func (r ApiGetApplicationsHistoryMetricRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetApplicationsHistoryMetricExecute(r)
}

/*
GetApplicationsHistoryMetric Gets application history metrics
...
*/
func (a *SbomDashboardAPIService) GetApplicationsHistoryMetric(ctx context.Context) ApiGetApplicationsHistoryMetricRequest {
	return ApiGetApplicationsHistoryMetricRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SbomDashboardAPIService) GetApplicationsHistoryMetricExecute(r ApiGetApplicationsHistoryMetricRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SbomDashboardAPIService.GetApplicationsHistoryMetric")
	if err != nil {
...
type ApiGetVulnerabilitiesByThreatLevelRequest struct {
	ctx context.Context
	ApiService *SbomDashboardAPIService
}

func (r ApiGetVulnerabilitiesByThreatLevelRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVulnerabilitiesByThreatLevelExecute(r)
}

/*
GetVulnerabilitiesByThreatLevel Gets counters of vulnerabilities and annotations by threat level

Queries how many vulnerabilities and annotations have been found by each threat level

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetVulnerabilitiesByThreatLevelRequest
*/
func (a *SbomDashboardAPIService) GetVulnerabilitiesByThreatLevel(ctx context.Context) ApiGetVulnerabilitiesByThreatLevelRequest {
	return ApiGetVulnerabilitiesByThreatLevelRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SbomDashboardAPIService) GetVulnerabilitiesByThreatLevelExecute(r ApiGetVulnerabilitiesByThreatLevelRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SbomDashboardAPIService.GetVulnerabilitiesByThreatLevel")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sbom/dashboard/vulnerabilitiesByThreatLevel"
