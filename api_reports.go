...
func (r ApiGetMetricsRequest) Execute() ([]ApiMetricsReportingDTOV2, *http.Response, error) {
...
func (a *ReportsAPIService) GetMetricsExecute(r ApiGetMetricsRequest) ([]ApiMetricsReportingDTOV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ApiMetricsReportingDTOV2
	)
