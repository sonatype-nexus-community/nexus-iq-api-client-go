...
type ApiGetMetadata1Request struct {
	ctx context.Context
	ApiService *ConfigSAMLAPIService
}

func (r ApiGetMetadata1Request) Execute() (string, *http.Response, error) {
	return r.ApiService.GetMetadata1Execute(r)
}

/*
GetMetadata1 Method for GetMetadata1
...
Permissions required: Edit System Configuration and Users
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMetadata1Request
*/
func (a *ConfigSAMLAPIService) GetMetadata1(ctx context.Context) ApiGetMetadata1Request {
	return ApiGetMetadata1Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *ConfigSAMLAPIService) GetMetadata1Execute(r ApiGetMetadata1Request) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConfigSAMLAPIService.GetMetadata1")
	if err != nil {
