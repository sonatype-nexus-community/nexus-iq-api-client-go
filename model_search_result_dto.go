...
type SearchResultDTO struct {
	...
	TotalNumberOfHits *int64 `json:"totalNumberOfHits,omitempty"`
}
...
// SetTotalNumberOfHits gets a reference to the given int64 and assigns it to the TotalNumberOfHits field.
