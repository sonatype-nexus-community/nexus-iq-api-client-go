...
type ApiAddBulkPolicyWaiversRequest struct {
	ctx context.Context
...
func (r ApiAddBulkPolicyWaiversRequest) ApiBulkWaiversDTO(apiBulkWaiversDTO ApiBulkWaiversDTO) ApiAddBulkPolicyWaiversRequest {
	r.apiBulkWaiversDTO = &apiBulkWaiversDTO
	return r
}

func (r ApiAddBulkPolicyWaiversRequest) Execute() (*http.Response, error) {
	return r.ApiService.AddBulkPolicyWaiversExecute(r)
}

/*
AddBulkPolicyWaivers Method for AddBulkPolicyWaivers
...
Permissions required: Waive Policy Violations
 ...
 @return ApiAddBulkPolicyWaiversRequest
*/
func (a *PolicyWaiversAPIService) AddBulkPolicyWaivers(ctx context.Context, ownerType string, ownerId string) ApiAddBulkPolicyWaiversRequest {
	return ApiAddBulkPolicyWaiversRequest{
		ApiService: a,
		ctx: ctx,
		ownerType: ownerType,
...
func (a *PolicyWaiversAPIService) AddBulkPolicyWaiversExecute(r ApiAddBulkPolicyWaiversRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PolicyWaiversAPIService.AddBulkPolicyWaivers")
	if err != nil {
...
type ApiGetPolicyWaiver1Request struct {
	ctx context.Context
	ApiService *PolicyWaiversAPIService
	ownerType string
	ownerId string
...
func (r ApiGetPolicyWaiver1Request) Execute() (*ApiPolicyWaiverDTO, *http.Response, error) {
	return r.ApiService.GetPolicyWaiver1Execute(r)
}

/*
GetPolicyWaiver1 Method for GetPolicyWaiver1
...
Permissions required: View IQ Elements
 ...
 @return ApiGetPolicyWaiver1Request
*/
func (a *PolicyWaiversAPIService) GetPolicyWaiver1(ctx context.Context, ownerType string, ownerId string, policyWaiverId string) ApiGetPolicyWaiver1Request {
	return ApiGetPolicyWaiver1Request{
		ApiService: a,
		ctx: ctx,
		ownerType: ownerType,
...
func (a *PolicyWaiversAPIService) GetPolicyWaiver1Execute(r ApiGetPolicyWaiver1Request) (*ApiPolicyWaiverDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PolicyWaiversAPIService.GetPolicyWaiver1")
	if err != nil {
...
type ApiGetPolicyWaiversRequest struct {
	...
	ownerType string
	ownerId string
	expiringWithin *int32
}

// When specified, only returns active waivers expiring within this many days from now. Must be a positive integer. For example, expiringWithin&#x3D;7 returns waivers expiring in the next 7 days.
func (r ApiGetPolicyWaiversRequest) ExpiringWithin(expiringWithin int32) ApiGetPolicyWaiversRequest {
	r.expiringWithin = &expiringWithin
	return r
}
...
func (a *PolicyWaiversAPIService) GetPolicyWaiversExecute(r ApiGetPolicyWaiversRequest) ([]ApiPolicyWaiverDTO, *http.Response, error) {
	...
	if r.expiringWithin != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expiringWithin", r.expiringWithin, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
