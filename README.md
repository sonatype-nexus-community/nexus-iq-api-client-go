...
*SbomDashboardAPI* | [**GetApplicationsHistoryMetric**](docs/SbomDashboardAPI.md#getapplicationshistorymetric) | **Get** /api/v2/sbom/dashboard/sbomsHistoryMetrics | Gets application history metrics
*SbomDashboardAPI* | [**GetSbomsAnalyzedMetrics**](docs/SbomDashboardAPI.md#getsbomsanalyzedmetrics) | **Get** /api/v2/sbom/dashboard/sbomsAnalyzed | Gets total of SBOMs analyzed and the threshold in the product license
*SbomDashboardAPI* | [**GetVulnerabilitiesByThreatLevel**](docs/SbomDashboardAPI.md#getvulnerabilitiesbythreatlevel) | **Get** /api/v2/sbom/dashboard/vulnerabilitiesByThreatLevel | Gets counters of vulnerabilities and annotations by threat level
