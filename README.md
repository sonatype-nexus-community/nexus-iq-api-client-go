...
*ApplicationReportDataAPI* | [**GetMetadata**](docs/ApplicationReportDataAPI.md#getmetadata) | **Get** /api/v2/applications/{applicationPublicId}/reports/{scanId}/metadata | 
...
*CIConfigurationAPI* | [**DeleteConfiguration**](docs/CIConfigurationAPI.md#deleteconfiguration) | **Delete** /api/v2/config/ci/{ownerType}/{ownerId} | 
*CIConfigurationAPI* | [**GetConfiguration**](docs/CIConfigurationAPI.md#getconfiguration) | **Get** /api/v2/config/ci/{ownerType}/{ownerId} | 
*CIConfigurationAPI* | [**SetConfiguration**](docs/CIConfigurationAPI.md#setconfiguration) | **Put** /api/v2/config/ci/{ownerType}/{ownerId} | 
...
*ComponentSearchAPI* | [**ExportComponentSearchReport**](docs/ComponentSearchAPI.md#exportcomponentsearchreport) | **Get** /api/v2/componentSearch/downloadComponentSearchReport | 
*ComponentSearchAPI* | [**GetCveAffectedComponents**](docs/ComponentSearchAPI.md#getcveaffectedcomponents) | **Get** /api/v2/componentSearch/cveAffectedComponents | 
...
*ConfigJiraAPI* | [**DeleteConfiguration2**](docs/ConfigJiraAPI.md#deleteconfiguration2) | **Delete** /api/v2/config/jira | 
*ConfigJiraAPI* | [**GetConfiguration2**](docs/ConfigJiraAPI.md#getconfiguration2) | **Get** /api/v2/config/jira | 
*ConfigJiraAPI* | [**SetConfiguration2**](docs/ConfigJiraAPI.md#setconfiguration2) | **Put** /api/v2/config/jira | 
*ConfigMailAPI* | [**DeleteConfiguration3**](docs/ConfigMailAPI.md#deleteconfiguration3) | **Delete** /api/v2/config/mail | 
*ConfigMailAPI* | [**GetConfiguration3**](docs/ConfigMailAPI.md#getconfiguration3) | **Get** /api/v2/config/mail | 
*ConfigMailAPI* | [**SetConfiguration3**](docs/ConfigMailAPI.md#setconfiguration3) | **Put** /api/v2/config/mail | 
*ConfigMailAPI* | [**TestConfiguration**](docs/ConfigMailAPI.md#testconfiguration) | **Post** /api/v2/config/mail/test/{recipientEmail} | 
*ConfigOIDCAPI* | [**DeleteOidcConfiguration**](docs/ConfigOIDCAPI.md#deleteoidcconfiguration) | **Delete** /api/v2/config/oidc | 
*ConfigOIDCAPI* | [**GetOidcConfiguration**](docs/ConfigOIDCAPI.md#getoidcconfiguration) | **Get** /api/v2/config/oidc | 
*ConfigOIDCAPI* | [**InsertOrUpdateOidcConfiguration**](docs/ConfigOIDCAPI.md#insertorupdateoidcconfiguration) | **Put** /api/v2/config/oidc | 
*ConfigProxyServerAPI* | [**DeleteConfiguration4**](docs/ConfigProxyServerAPI.md#deleteconfiguration4) | **Delete** /api/v2/config/httpProxyServer | 
*ConfigProxyServerAPI* | [**GetConfiguration4**](docs/ConfigProxyServerAPI.md#getconfiguration4) | **Get** /api/v2/config/httpProxyServer | 
*ConfigProxyServerAPI* | [**SetConfiguration4**](docs/ConfigProxyServerAPI.md#setconfiguration4) | **Put** /api/v2/config/httpProxyServer | 
*ConfigReverseProxyAuthenticationAPI* | [**DeleteConfiguration5**](docs/ConfigReverseProxyAuthenticationAPI.md#deleteconfiguration5) | **Delete** /api/v2/config/reverseProxyAuthentication | 
*ConfigReverseProxyAuthenticationAPI* | [**GetConfiguration5**](docs/ConfigReverseProxyAuthenticationAPI.md#getconfiguration5) | **Get** /api/v2/config/reverseProxyAuthentication | 
*ConfigReverseProxyAuthenticationAPI* | [**SetConfiguration5**](docs/ConfigReverseProxyAuthenticationAPI.md#setconfiguration5) | **Put** /api/v2/config/reverseProxyAuthentication | 
*ConfigSAMLAPI* | [**DeleteSamlConfiguration**](docs/ConfigSAMLAPI.md#deletesamlconfiguration) | **Delete** /api/v2/config/saml | 
*ConfigSAMLAPI* | [**GetMetadata1**](docs/ConfigSAMLAPI.md#getmetadata1) | **Get** /api/v2/config/saml/metadata | 
...
*ConfigSourceControlAPI* | [**DeleteConfiguration7**](docs/ConfigSourceControlAPI.md#deleteconfiguration7) | **Delete** /api/v2/config/sourceControl | 
*ConfigSourceControlAPI* | [**GetConfiguration7**](docs/ConfigSourceControlAPI.md#getconfiguration7) | **Get** /api/v2/config/sourceControl | 
*ConfigSourceControlAPI* | [**SetConfiguration6**](docs/ConfigSourceControlAPI.md#setconfiguration6) | **Put** /api/v2/config/sourceControl | 
...
*ConfigZscalerAPI* | [**DeleteConfiguration8**](docs/ConfigZscalerAPI.md#deleteconfiguration8) | **Delete** /api/v2/config/zscaler | 
*ConfigZscalerAPI* | [**GetConfiguration9**](docs/ConfigZscalerAPI.md#getconfiguration9) | **Get** /api/v2/config/zscaler | 
*ConfigZscalerAPI* | [**GetQuota**](docs/ConfigZscalerAPI.md#getquota) | **Get** /api/v2/config/zscaler/zscalerLimits | 
*ConfigZscalerAPI* | [**SetConfiguration7**](docs/ConfigZscalerAPI.md#setconfiguration7) | **Put** /api/v2/config/zscaler | 
...
*ConfigurationAPI* | [**DeleteConfiguration1**](docs/ConfigurationAPI.md#deleteconfiguration1) | **Delete** /api/v2/config | 
*ConfigurationAPI* | [**GetConfiguration1**](docs/ConfigurationAPI.md#getconfiguration1) | **Get** /api/v2/config | 
*ConfigurationAPI* | [**InvalidateCache**](docs/ConfigurationAPI.md#invalidatecache) | **Delete** /api/v2/config/integrationVersions/cache | 
*ConfigurationAPI* | [**SetConfiguration1**](docs/ConfigurationAPI.md#setconfiguration1) | **Put** /api/v2/config | 
...
*ConsumptionAPI* | [**ExportCsv**](docs/ConsumptionAPI.md#exportcsv) | **Get** /api/v2/consumption/export | 
*ConsumptionAPI* | [**GetDailyHistory**](docs/ConsumptionAPI.md#getdailyhistory) | **Get** /api/v2/consumption/daily-history | 
*ConsumptionAPI* | [**GetHistory**](docs/ConsumptionAPI.md#gethistory) | **Get** /api/v2/consumption/history | 
*ConsumptionAPI* | [**GetHistoryBreakdown**](docs/ConsumptionAPI.md#gethistorybreakdown) | **Get** /api/v2/consumption/history/breakdown | 
*ConsumptionAPI* | [**GetHistoryBySource**](docs/ConsumptionAPI.md#gethistorybysource) | **Get** /api/v2/consumption/history/by-source | 
*ConsumptionAPI* | [**GetHistoryByStage**](docs/ConsumptionAPI.md#gethistorybystage) | **Get** /api/v2/consumption/history/by-stage | 
*ConsumptionAPI* | [**GetSummary**](docs/ConsumptionAPI.md#getsummary) | **Get** /api/v2/consumption/summary | 
*ConsumptionAPI* | [**GetTopApps**](docs/ConsumptionAPI.md#gettopapps) | **Get** /api/v2/consumption/top-apps | 
...
*FirewallAPI* | [**AddBulkWaivers**](docs/FirewallAPI.md#addbulkwaivers) | **Post** /api/v2/firewall/repositories/{ownerType}/{ownerId}/waivers/bulk | 
*FirewallAPI* | [**AddProprietaryComponentNames**](docs/FirewallAPI.md#addproprietarycomponentnames) | **Post** /api/v2/firewall/namespace_confusion/{format} | 
*FirewallAPI* | [**AddRepository**](docs/FirewallAPI.md#addrepository) | **Post** /api/v2/firewall/repositoryManagers/{repositoryManagerId}/repositories | 
*FirewallAPI* | [**AddRepositoryManager**](docs/FirewallAPI.md#addrepositorymanager) | **Post** /api/v2/firewall/repositoryManagers | 
*FirewallAPI* | [**AddVirtualRepositoryManager**](docs/FirewallAPI.md#addvirtualrepositorymanager) | **Post** /api/v2/firewall/virtualManagers | 
*FirewallAPI* | [**AddWaiver**](docs/FirewallAPI.md#addwaiver) | **Post** /api/v2/firewall/container-image/{containerImageId}/policyWaiver | 
...
*FirewallAPI* | [**DeleteContainerImagePolicyWaiver**](docs/FirewallAPI.md#deletecontainerimagepolicywaiver) | **Delete** /api/v2/firewall/container-image/{containerImageId}/policyWaiver | 
...
*FirewallAPI* | [**GetCascadeStatus**](docs/FirewallAPI.md#getcascadestatus) | **Get** /api/v2/firewall/repositories/cascade-reevaluate/status/{requestId} | 
...
*FirewallAPI* | [**GetContainerImagesInQuarantine**](docs/FirewallAPI.md#getcontainerimagesinquarantine) | **Get** /api/v2/firewall/container-image/policyViolations/quarantined | 
...
*FirewallAPI* | [**GetPolicyWaiver**](docs/FirewallAPI.md#getpolicywaiver) | **Get** /api/v2/firewall/policyWaivers/{ownerType}/{ownerId}/{policyWaiverId} | 
...
*FirewallAPI* | [**GetWaivers**](docs/FirewallAPI.md#getwaivers) | **Get** /api/v2/firewall/container-image/policyWaiver | 
*FirewallAPI* | [**InitiateCascadeReevaluation**](docs/FirewallAPI.md#initiatecascadereevaluation) | **Post** /api/v2/firewall/repositories/cascade-reevaluate/componentHash/{componentHash} | 
*FirewallAPI* | [**RemoveProprietaryComponentNames**](docs/FirewallAPI.md#removeproprietarycomponentnames) | **Delete** /api/v2/firewall/namespace_confusion/{format} | 
*FirewallAPI* | [**RenewWaivers**](docs/FirewallAPI.md#renewwaivers) | **Post** /api/v2/firewall/waivers/renew | 
*FirewallAPI* | [**RequestWaiver**](docs/FirewallAPI.md#requestwaiver) | **Post** /api/v2/firewall/container-image/{containerImageId}/policyWaiverRequest | 
...
*FirewallAPI* | [**VerifyConnectionAndGetApplications**](docs/FirewallAPI.md#verifyconnectionandgetapplications) | **Get** /api/v2/firewall/connection/verify | 
*GitHubAppAPI* | [**DeleteGitHubApp**](docs/GitHubAppAPI.md#deletegithubapp) | **Delete** /api/v2/githubApp/{githubAppId} | Delete a GitHub App
*GitHubAppAPI* | [**ListGitHubApps**](docs/GitHubAppAPI.md#listgithubapps) | **Get** /api/v2/githubApp | List GitHub Apps for an owner
*GitHubAppConfigurationAPI* | [**GenerateManifest**](docs/GitHubAppConfigurationAPI.md#generatemanifest) | **Post** /api/v2/githubApp/manifest | Generate GitHub App manifest
*GitHubAppConfigurationAPI* | [**HandleInstallationSetup**](docs/GitHubAppConfigurationAPI.md#handleinstallationsetup) | **Get** /api/v2/githubApp/setupInstallation | Handle GitHub App installation setup callback with OAuth + PKCE
*GitHubAppConfigurationAPI* | [**HandleRedirect**](docs/GitHubAppConfigurationAPI.md#handleredirect) | **Get** /api/v2/githubApp/redirect | GitHub App registration redirect callback
*LegacyViolationsAPI* | [**Grant**](docs/LegacyViolationsAPI.md#grant) | **Post** /api/v2/legacyViolations/application/{applicationPublicId}/grant | 
*LegacyViolationsAPI* | [**ListLegacyViolations**](docs/LegacyViolationsAPI.md#listlegacyviolations) | **Get** /api/v2/legacyViolations/application/{applicationPublicId} | 
*LegacyViolationsAPI* | [**Revoke**](docs/LegacyViolationsAPI.md#revoke) | **Post** /api/v2/legacyViolations/application/{applicationPublicId}/revoke | 
*LegacyViolationsConfigurationAPI* | [**GetConfig**](docs/LegacyViolationsConfigurationAPI.md#getconfig) | **Get** /api/v2/config/legacyViolations/{ownerType}/{ownerId} | 
*LegacyViolationsConfigurationAPI* | [**SetConfig**](docs/LegacyViolationsConfigurationAPI.md#setconfig) | **Put** /api/v2/config/legacyViolations/{ownerType}/{ownerId} | 
...
*OrganizationsAPI* | [**GetOrganizationsByIds**](docs/OrganizationsAPI.md#getorganizationsbyids) | **Get** /api/v2/organizations/byid | 
...
*PolicyExportAPI* | [**ExportPolicies**](docs/PolicyExportAPI.md#exportpolicies) | **Get** /api/v2/policy/{ownerType}/{ownerId}/export | Export policy configuration
...
*PolicyWaiverRequestsAPI* | [**GetPolicyWaiverRequests**](docs/PolicyWaiverRequestsAPI.md#getpolicywaiverrequests) | **Get** /api/v2/policyWaiverRequests/{ownerType}/{ownerId} | 
...
*PolicyWaiversAPI* | [**AddBulkPolicyWaivers**](docs/PolicyWaiversAPI.md#addbulkpolicywaivers) | **Post** /api/v2/policyWaivers/{ownerType}/{ownerId} | 
...
*PolicyWaiversAPI* | [**GetPolicyWaiver1**](docs/PolicyWaiversAPI.md#getpolicywaiver1) | **Get** /api/v2/policyWaivers/{ownerType}/{ownerId}/{policyWaiverId} | 
...
*ReachabilityEvidenceAPI* | [**GetReachabilityEvidence**](docs/ReachabilityEvidenceAPI.md#getreachabilityevidence) | **Get** /api/v2/applications/{applicationPublicId}/reports/{reportId}/vulnerabilities/{vulnerabilityId}/reachability-evidence | 
...
*RepositoriesAPI* | [**UploadScan**](docs/RepositoriesAPI.md#uploadscan) | **Post** /api/v2/repositories/{repositoryManagerId}/{repositoryId}/components | 
*RoleMembershipsAPI* | [**GetBulkRoleMembershipsGlobalOrRepositoryContainer**](docs/RoleMembershipsAPI.md#getbulkrolemembershipsglobalorrepositorycontainer) | **Get** /api/v2/roleMemberships/{ownerType}/roles | 
*RoleMembershipsAPI* | [**GetBulkRoleMembershipsNonGlobal**](docs/RoleMembershipsAPI.md#getbulkrolemembershipsnonglobal) | **Get** /api/v2/roleMemberships/{ownerType}/{internalOwnerId}/roles | 
...
*RoleMembershipsAPI* | [**SetBulkRoleMembersGlobalOrRepositoryContainer**](docs/RoleMembershipsAPI.md#setbulkrolemembersglobalorrepositorycontainer) | **Put** /api/v2/roleMemberships/{ownerType}/role/{roleId}/members | 
*RoleMembershipsAPI* | [**SetBulkRoleMembersNonGlobal**](docs/RoleMembershipsAPI.md#setbulkrolemembersnonglobal) | **Put** /api/v2/roleMemberships/{ownerType}/{internalOwnerId}/role/{roleId}/members | 
*RolesAPI* | [**AddRole**](docs/RolesAPI.md#addrole) | **Post** /api/v2/roles | 
*RolesAPI* | [**DeleteRole**](docs/RolesAPI.md#deleterole) | **Delete** /api/v2/roles/{roleId} | 
*RolesAPI* | [**GetRoleById**](docs/RolesAPI.md#getrolebyid) | **Get** /api/v2/roles/{roleId} | 
*RolesAPI* | [**GetRoles**](docs/RolesAPI.md#getroles) | **Get** /api/v2/roles | 
*RolesAPI* | [**GetTemplateForNewRole**](docs/RolesAPI.md#gettemplatefornewrole) | **Get** /api/v2/roles/new | 
*RolesAPI* | [**UpdateRole**](docs/RolesAPI.md#updaterole) | **Put** /api/v2/roles/{roleId} | 
...
*ScanHealthConfigurationAPI* | [**DeleteConfiguration6**](docs/ScanHealthConfigurationAPI.md#deleteconfiguration6) | **Delete** /api/v2/config/scanHealth/{ownerType}/{ownerId} | 
*ScanHealthConfigurationAPI* | [**GetConfiguration6**](docs/ScanHealthConfigurationAPI.md#getconfiguration6) | **Get** /api/v2/config/scanHealth/{ownerType}/{ownerId} | 
*ScanHealthConfigurationAPI* | [**SaveConfiguration**](docs/ScanHealthConfigurationAPI.md#saveconfiguration) | **Put** /api/v2/config/scanHealth/{ownerType}/{ownerId} | 
...
*SourceControlAPI* | [**DeregisterFromRelay**](docs/SourceControlAPI.md#deregisterfromrelay) | **Post** /api/v2/sourceControl/relay/deregister | 
*SourceControlAPI* | [**GetGitHubAppWebhookUrl**](docs/SourceControlAPI.md#getgithubappwebhookurl) | **Get** /api/v2/sourceControl/githubAppWebhookUrl | 
*SourceControlAPI* | [**GetRelayWebhookSecret**](docs/SourceControlAPI.md#getrelaywebhooksecret) | **Get** /api/v2/sourceControl/relayWebhookSecret | 
*SourceControlAPI* | [**GetRelayWebhookUrl**](docs/SourceControlAPI.md#getrelaywebhookurl) | **Get** /api/v2/sourceControl/relayWebhookUrl | 
...
*SourceControlAPI* | [**RegisterWithRelay**](docs/SourceControlAPI.md#registerwithrelay) | **Post** /api/v2/sourceControl/relay/register | 
*SourceControlAPI* | [**RotateRelayApiKey**](docs/SourceControlAPI.md#rotaterelayapikey) | **Post** /api/v2/sourceControl/relay/rotate-key | 
*SourceControlAPI* | [**RotateRelayWebhookSecret**](docs/SourceControlAPI.md#rotaterelaywebhooksecret) | **Post** /api/v2/sourceControl/relay/rotate-webhook-secret | 
...
*UserTokenConfigurationAPI* | [**GetConfiguration8**](docs/UserTokenConfigurationAPI.md#getconfiguration8) | **Get** /api/v2/config/userTokens | 
*UserTokenConfigurationAPI* | [**ResetConfiguration**](docs/UserTokenConfigurationAPI.md#resetconfiguration) | **Delete** /api/v2/config/userTokens | 
*UserTokenConfigurationAPI* | [**UpdateConfiguration**](docs/UserTokenConfigurationAPI.md#updateconfiguration) | **Put** /api/v2/config/userTokens | 
...
*UserTokensAPI* | [**GetCurrentUserTokenCreateTime**](docs/UserTokensAPI.md#getcurrentusertokencreatetime) | **Get** /api/v2/userTokens/currentUser/createTime | 
...
*VulnerabilityDetailsAPI* | [**GetSecurityVulnerabilityDetails**](docs/VulnerabilityDetailsAPI.md#getsecurityvulnerabilitydetails) | **Post** /api/v2/vulnerabilities | 
*VulnerabilityDetailsAPI* | [**GetSecurityVulnerabilityDetails1**](docs/VulnerabilityDetailsAPI.md#getsecurityvulnerabilitydetails1) | **Get** /api/v2/vulnerabilities/{refId} | 
*WaiverExpirationNotificationConfigAPI* | [**GetConfig1**](docs/WaiverExpirationNotificationConfigAPI.md#getconfig1) | **Get** /api/v2/waiverExpirationNotificationConfig/{ownerType}/{ownerId} | 
*WaiverExpirationNotificationConfigAPI* | [**SaveConfig**](docs/WaiverExpirationNotificationConfigAPI.md#saveconfig) | **Put** /api/v2/waiverExpirationNotificationConfig/{ownerType}/{ownerId} | 


## Documentation For Models

 - [Action](docs/Action.md)
 - [ApiAiModelContentTypeDTO](docs/ApiAiModelContentTypeDTO.md)
 - [ApiAiModelDataDTO](docs/ApiAiModelDataDTO.md)
 - [ApiApplicableMembershipMappingsDTO](docs/ApiApplicableMembershipMappingsDTO.md)
 ...
 - [ApiCiConfigurationDto](docs/ApiCiConfigurationDto.md)
 - [ApiCiConfigurationResponseDto](docs/ApiCiConfigurationResponseDto.md)
 ...
 - [ApiCompositeValueDTOGitHubAppInfo](docs/ApiCompositeValueDTOGitHubAppInfo.md)
 ...
 - [ApiContainerImageWaiverRequestDTO](docs/ApiContainerImageWaiverRequestDTO.md)
 ...
 - [ApiLegacyViolationChangeResponseDTO](docs/ApiLegacyViolationChangeResponseDTO.md)
 - [ApiLegacyViolationStatusDTO](docs/ApiLegacyViolationStatusDTO.md)
 ...
 - [ApiMemberWithDetailsDTO](docs/ApiMemberWithDetailsDTO.md)
 - [ApiMembersByOwnerDTO](docs/ApiMembersByOwnerDTO.md)
 ...
 - [ApiPermissionCategoryDTO](docs/ApiPermissionCategoryDTO.md)
 - [ApiPermissionDTO](docs/ApiPermissionDTO.md)
 ...
 - [ApiReachabilityEvidenceResponse](docs/ApiReachabilityEvidenceResponse.md)
 ...
 - [ApiRoleWithMembersByOwnerDTO](docs/ApiRoleWithMembersByOwnerDTO.md)
 ...
 - [ApiUserTokenConfigurationDTO](docs/ApiUserTokenConfigurationDTO.md)
 ...
 - [ApiWaiverExpirationNotificationConfigDTO](docs/ApiWaiverExpirationNotificationConfigDTO.md)
 ...
 - [ApplicationSummaryList](docs/ApplicationSummaryList.md)
 ...
 - [CacheInvalidationResponse](docs/CacheInvalidationResponse.md)
 - [CascadeComponentProgressDTO](docs/CascadeComponentProgressDTO.md)
 - [CascadeReevaluateTicketDTO](docs/CascadeReevaluateTicketDTO.md)
 - [CascadeStatusResponseDTO](docs/CascadeStatusResponseDTO.md)
 ...
 - [DotNetAnalysisConfig](docs/DotNetAnalysisConfig.md)
 - [DownloadConfig](docs/DownloadConfig.md)
 - [EpssData](docs/EpssData.md)
 - [EvidencePath](docs/EvidencePath.md)
 - [GetSuggestedRemediationForComponent200Response](docs/GetSuggestedRemediationForComponent200Response.md)
 - [GitHubAppInfo](docs/GitHubAppInfo.md)
 ...
 - [JavaAnalysisConfig](docs/JavaAnalysisConfig.md)
 - [JavaScriptAnalysisConfig](docs/JavaScriptAnalysisConfig.md)
 - [JiraNotification](docs/JiraNotification.md)
 ...
 - [LicenseThreatGroup](docs/LicenseThreatGroup.md)
 - [LicenseThreatGroupDTO](docs/LicenseThreatGroupDTO.md)
 - [LicenseThreatGroupLicense](docs/LicenseThreatGroupLicense.md)
 ...
 - [OAuth2ConfigurationDTO](docs/OAuth2ConfigurationDTO.md)
 - [OidcConfigurationDTO](docs/OidcConfigurationDTO.md)
 ...
 - [PolicyExportResult](docs/PolicyExportResult.md)
 ...
 - [ReachabilityConfig](docs/ReachabilityConfig.md)
 - [ReferenceLink](docs/ReferenceLink.md)
 - [ReferenceLinkDTO](docs/ReferenceLinkDTO.md)
 - [RelayRegisterAdminRequest](docs/RelayRegisterAdminRequest.md)
 - [RenewWaiversRequestDTO](docs/RenewWaiversRequestDTO.md)
 - [RoleNotification](docs/RoleNotification.md)
 ...
 - [ScanHealthConfigDTO](docs/ScanHealthConfigDTO.md)
 ...
 - [SsoConfigurationDTO](docs/SsoConfigurationDTO.md)
 ...
 - [UploadScanRequest](docs/UploadScanRequest.md)
...
```go
auth := context.WithValue(context.Background(), sonatypeiq.ContextAccessToken, "BEARER_TOKEN_STRING")
r, err := client.Service.Operation(auth, args)
```
