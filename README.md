...
*CallFlowAnalysisAPI* | [**DeleteCallFlowAnalysisConfig**](docs/CallFlowAnalysisAPI.md#deletecallflowanalysisconfig) | **Delete** /api/v2/callFlowAnalysis/configuration/{ownerType}/{ownerId} | 
*CallFlowAnalysisAPI* | [**GetCallFlowAnalysisConfig**](docs/CallFlowAnalysisAPI.md#getcallflowanalysisconfig) | **Get** /api/v2/callFlowAnalysis/configuration/{ownerType}/{ownerId} | 
*CallFlowAnalysisAPI* | [**GetCallFlowAnalysisConfigByPublicId**](docs/CallFlowAnalysisAPI.md#getcallflowanalysisconfigbypublicid) | **Get** /api/v2/callFlowAnalysis/configuration/{ownerType}/{ownerId}/publicId | 
*CallFlowAnalysisAPI* | [**UpsertCallFlowAnalysisConfig**](docs/CallFlowAnalysisAPI.md#upsertcallflowanalysisconfig) | **Put** /api/v2/callFlowAnalysis/configuration/{ownerType}/{ownerId} | 
...
*SbomAPI* | [**DeleteSbomVersion**](docs/SbomAPI.md#deletesbomversion) | **Delete** /api/v2/sbom/{applicationId}/version/{sbomVersion} | Delete sbom version
*SbomAPI* | [**GetImportStatus**](docs/SbomAPI.md#getimportstatus) | **Get** /api/v2/sbom/{applicationId}/status/{importRequestId} | Get sbom import status
*SbomAPI* | [**GetListOfSbomsForApplicationId**](docs/SbomAPI.md#getlistofsbomsforapplicationid) | **Get** /api/v2/sbom/application/{applicationId} | Gets a paginated list of SBOMs for an application
*SbomAPI* | [**GetSbomComponents**](docs/SbomAPI.md#getsbomcomponents) | **Get** /api/v2/sbom/{applicationId}/version/{sbomVersion}/components | Gets the components found in a specific sbom version
*SbomAPI* | [**GetSbomVersion**](docs/SbomAPI.md#getsbomversion) | **Get** /api/v2/sbom/{applicationId}/version/{sbomVersion} | Gets a sbom version
*SbomAPI* | [**GetSbomVersionListByApplication**](docs/SbomAPI.md#getsbomversionlistbyapplication) | **Get** /api/v2/sbom/sbomVersions/{applicationId} | Gets a list of sbom versions by application id
...
## Documentation For Models
 ...
 - [ApiCallFlowAnalysisConfigDTO](docs/ApiCallFlowAnalysisConfigDTO.md)
