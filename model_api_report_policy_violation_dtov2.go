...
type ApiReportPolicyViolationDTOV2 struct {
	...
	WaivedWithAutoWaiver *bool `json:"waivedWithAutoWaiver,omitempty"`
}
...
// GetWaivedWithAutoWaiver returns the WaivedWithAutoWaiver field value if set, zero value otherwise.
func (o *ApiReportPolicyViolationDTOV2) GetWaivedWithAutoWaiver() bool {
	if o == nil || IsNil(o.WaivedWithAutoWaiver) {
		var ret bool
		return ret
	}
	return *o.WaivedWithAutoWaiver
}

// GetWaivedWithAutoWaiverOk returns a tuple with the WaivedWithAutoWaiver field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiReportPolicyViolationDTOV2) GetWaivedWithAutoWaiverOk() (*bool, bool) {
	if o == nil || IsNil(o.WaivedWithAutoWaiver) {
		return nil, false
	}
	return o.WaivedWithAutoWaiver, true
}
...
// SetWaivedWithAutoWaiver gets a reference to the given bool and assigns it to the WaivedWithAutoWaiver field.
func (o *ApiReportPolicyViolationDTOV2) SetWaivedWithAutoWaiver(v bool) {
	o.WaivedWithAutoWaiver = &v
}
...
func (o ApiReportPolicyViolationDTOV2) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WaivedWithAutoWaiver) {
		toSerialize["waivedWithAutoWaiver"] = o.WaivedWithAutoWaiver
	}
