...
type ApiSourceControlDTO struct {
	...
	NonGoldenPullRequestsEnabled *bool `json:"nonGoldenPullRequestsEnabled,omitempty"`
...
// SetNonGoldenPullRequestsEnabled gets a reference to the given bool and assigns it to the NonGoldenPullRequestsEnabled field.
