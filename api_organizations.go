...
Permissions required: Edit IQ Elements
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Enter the organization id to be deleted.
...
Permissions required: View IQ Elements
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Enter the organization id.
...
type ApiGetOrganizationsByIdsRequest struct {
	ctx context.Context
	ApiService *OrganizationsAPIService
	id *[]string
}

// Enter the internal organization IDs.
func (r ApiGetOrganizationsByIdsRequest) Id(id []string) ApiGetOrganizationsByIdsRequest {
	r.id = &id
	return r
}

func (r ApiGetOrganizationsByIdsRequest) Execute() (*ApiOrganizationListDTO, *http.Response, error) {
	return r.ApiService.GetOrganizationsByIdsExecute(r)
}

/*
GetOrganizationsByIds Method for GetOrganizationsByIds
...
Permissions required: View IQ Elements
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOrganizationsByIdsRequest
*/
func (a *OrganizationsAPIService) GetOrganizationsByIds(ctx context.Context) ApiGetOrganizationsByIdsRequest {
	return ApiGetOrganizationsByIdsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ApiOrganizationListDTO
func (a *OrganizationsAPIService) GetOrganizationsByIdsExecute(r ApiGetOrganizationsByIdsRequest) (*ApiOrganizationListDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.GetOrganizationsByIds")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/organizations/byid"
...
func (r ApiMoveOrganizationRequest) Execute() (*MoveOrganizationResponseDTO, *http.Response, error) {
...
Permissions required: Edit IQ Elements
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Enter the id for the organization to be moved under the new parent.
 @param destinationId Enter the id for the new parent organization.
...
func (a *OrganizationsAPIService) MoveOrganizationExecute(r ApiMoveOrganizationRequest) (*MoveOrganizationResponseDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MoveOrganizationResponseDTO
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 409 {
			var v MoveOrganizationResponseDTO
