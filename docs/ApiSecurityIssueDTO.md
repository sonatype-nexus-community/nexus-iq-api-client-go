...
`func (o *ApiSecurityIssueDTO) GetVulnIds() []string`

GetVulnIds returns the VulnIds field if non-nil, zero value otherwise.

### GetVulnIdsOk

`func (o *ApiSecurityIssueDTO) GetVulnIdsOk() (*[]string, bool)`
...
`func (o *ApiSecurityIssueDTO) SetVulnIds(v []string)`

SetVulnIds sets VulnIds field to given value.

### HasVulnIds

`func (o *ApiSecurityIssueDTO) HasVulnIds() bool`
