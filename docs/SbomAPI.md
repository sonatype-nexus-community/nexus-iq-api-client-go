...
[**GetImportStatus**](SbomAPI.md#GetImportStatus) | **Get** /api/v2/sbom/{applicationId}/status/{importRequestId} | Get sbom import status
[**GetListOfSbomsForApplicationId**](SbomAPI.md#GetListOfSbomsForApplicationId) | **Get** /api/v2/sbom/application/{applicationId} | Gets a paginated list of SBOMs for an application
[**GetSbomComponents**](SbomAPI.md#GetSbomComponents) | **Get** /api/v2/sbom/{applicationId}/version/{sbomVersion}/components | Gets the components found in a specific sbom version
[**GetSbomVersion**](SbomAPI.md#GetSbomVersion) | **Get** /api/v2/sbom/{applicationId}/version/{sbomVersion} | Gets a sbom version
[**GetSbomVersionListByApplication**](SbomAPI.md#GetSbomVersionListByApplication) | **Get** /api/v2/sbom/sbomVersions/{applicationId} | Gets a list of sbom versions by application id
...
## GetListOfSbomsForApplicationId

> GetListOfSbomsForApplicationId(ctx, applicationId).SortByDate(sortByDate).PageSize(pageSize).Page(page).Execute()
...
func main() {
	...
	configuration := sonatypeiq.NewConfiguration()
	apiClient := sonatypeiq.NewAPIClient(configuration)
	r, err := apiClient.SbomAPI.GetListOfSbomsForApplicationId(context.Background(), applicationId).SortByDate(sortByDate).PageSize(pageSize).Page(page).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SbomAPI.GetListOfSbomsForApplicationId``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiGetListOfSbomsForApplicationIdRequest struct via the builder pattern
...
> GetSbomComponents(ctx, applicationId, sbomVersion).Execute()
...
func main() {
	applicationId := "applicationId_example" // string | The internal id of the application
	sbomVersion := "sbomVersion_example" // string | URL Encoded version value of the sbom to query its components

	configuration := sonatypeiq.NewConfiguration()
	apiClient := sonatypeiq.NewAPIClient(configuration)
	r, err := apiClient.SbomAPI.GetSbomComponents(context.Background(), applicationId, sbomVersion).Execute()
	if err != nil {
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**applicationId** | **string** | The internal id of the application | 
**sbomVersion** | **string** | URL Encoded version value of the sbom to query its components | 
...
> GetSbomVersion(ctx, applicationId, sbomVersion).State(state).Accept(accept).Execute()
...
func main() {
	applicationId := "applicationId_example" // string | The internal id of the application
	sbomVersion := "sbomVersion_example" // string | URL Encoded version value of the sbom
	...
	configuration := sonatypeiq.NewConfiguration()
	apiClient := sonatypeiq.NewAPIClient(configuration)
	r, err := apiClient.SbomAPI.GetSbomVersion(context.Background(), applicationId, sbomVersion).State(state).Accept(accept).Execute()
	if err != nil {
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**applicationId** | **string** | The internal id of the application | 
**sbomVersion** | **string** | URL Encoded version value of the sbom | 
