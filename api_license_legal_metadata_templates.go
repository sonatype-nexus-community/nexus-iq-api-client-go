...
// LicenseLegalMetadataTemplatesAPIService LicenseLegalMetadataTemplatesAPI service
type LicenseLegalMetadataTemplatesAPIService service

type ApiDeleteAttributionReportTemplateRequest struct {
	ctx context.Context
	ApiService *LicenseLegalMetadataTemplatesAPIService
	id string
}
...
*/
func (a *LicenseLegalMetadataTemplatesAPIService) DeleteAttributionReportTemplate(ctx context.Context, id string) ApiDeleteAttributionReportTemplateRequest {
	return ApiDeleteAttributionReportTemplateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *LicenseLegalMetadataTemplatesAPIService) DeleteAttributionReportTemplateExecute(r ApiDeleteAttributionReportTemplateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LicenseLegalMetadataTemplatesAPIService.DeleteAttributionReportTemplate")
	if err != nil {
...
*/
func (a *LicenseLegalMetadataTemplatesAPIService) GetAllAttributionReportTemplates(ctx context.Context) ApiGetAllAttributionReportTemplatesRequest {
	return ApiGetAllAttributionReportTemplatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LicenseLegalMetadataTemplatesAPIService) GetAllAttributionReportTemplatesExecute(r ApiGetAllAttributionReportTemplatesRequest) ([]AttributionReportTemplateDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LicenseLegalMetadataTemplatesAPIService.GetAllAttributionReportTemplates")
	if err != nil {
...
*/
func (a *LicenseLegalMetadataTemplatesAPIService) GetAttributionReportTemplateById(ctx context.Context, id string) ApiGetAttributionReportTemplateByIdRequest {
	return ApiGetAttributionReportTemplateByIdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return AttributionReportTemplateDTO
func (a *LicenseLegalMetadataTemplatesAPIService) GetAttributionReportTemplateByIdExecute(r ApiGetAttributionReportTemplateByIdRequest) (*AttributionReportTemplateDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LicenseLegalMetadataTemplatesAPIService.GetAttributionReportTemplateById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *LicenseLegalMetadataTemplatesAPIService) SaveAttributionReportTemplate(ctx context.Context) ApiSaveAttributionReportTemplateRequest {
	return ApiSaveAttributionReportTemplateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AttributionReportTemplateDTO
func (a *LicenseLegalMetadataTemplatesAPIService) SaveAttributionReportTemplateExecute(r ApiSaveAttributionReportTemplateRequest) (*AttributionReportTemplateDTO, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LicenseLegalMetadataTemplatesAPIService.SaveAttributionReportTemplate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
