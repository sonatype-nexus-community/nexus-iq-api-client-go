...
func (r ApiAddLicenseOverrideRequest) Execute() (*http.Response, error) {
...
func (a *LicenseOverridesAPIService) AddLicenseOverrideExecute(r ApiAddLicenseOverrideRequest) (*http.Response, error) {
	var (
	...
	if r.apiLicenseOverrideDTO == nil {
		return nil, reportError("apiLicenseOverrideDTO is required and must be specified")
	}
...
func (r ApiGetAppliedLicenseOverridesRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *LicenseOverridesAPIService) GetAppliedLicenseOverridesExecute(r ApiGetAppliedLicenseOverridesRequest) (*http.Response, error) {
	var (
	...
	if r.componentIdentifier == nil {
		return nil, reportError("componentIdentifier is required and must be specified")
	}
...
func (a *LicenseOverridesAPIService) GetAppliedLicenseOverridesForLegalReviewerExecute(r ApiGetAppliedLicenseOverridesForLegalReviewerRequest) (*ApiAppliedLicenseOverridesDTO, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		newErr := &GenericOpenAPIError{
			...
			var v ApiAppliedLicenseOverridesDTO
