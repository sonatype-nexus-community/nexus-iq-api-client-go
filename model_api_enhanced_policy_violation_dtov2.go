...
// GetIsWaived returns the IsWaived field value if set, zero value otherwise.
func (o *ApiEnhancedPolicyViolationDTOV2) GetIsWaived() bool {
	if o == nil || IsNil(o.IsWaived) {
		var ret bool
		return ret
	}
	return *o.IsWaived
...
// GetIsWaivedOk returns a tuple with the IsWaived field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiEnhancedPolicyViolationDTOV2) GetIsWaivedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsWaived) {
		return nil, false
	}
	return o.IsWaived, true
}
...
// SetIsWaived gets a reference to the given bool and assigns it to the IsWaived field.
...
func (o ApiEnhancedPolicyViolationDTOV2) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsWaived) {
		toSerialize["isWaived"] = o.IsWaived
	}
