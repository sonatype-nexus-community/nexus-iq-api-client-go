...
func Test_sonatypeiq_OrganizationsAPIService(t *testing.T) {
	...
	t.Run("Test OrganizationsAPIService GetOrganizationsByIds", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.OrganizationsAPI.GetOrganizationsByIds(context.Background()).Execute()
