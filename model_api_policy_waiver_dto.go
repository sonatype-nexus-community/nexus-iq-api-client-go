...
type ApiPolicyWaiverDTO struct {
	...
	LastRenewalComment *string `json:"lastRenewalComment,omitempty"`
	LastRenewalReasonText *string `json:"lastRenewalReasonText,omitempty"`
	LastRenewedAt *time.Time `json:"lastRenewedAt,omitempty"`
	LastRenewedBy *string `json:"lastRenewedBy,omitempty"`
...
// GetLastRenewalComment returns the LastRenewalComment field value if set, zero value otherwise.
func (o *ApiPolicyWaiverDTO) GetLastRenewalComment() string {
	if o == nil || IsNil(o.LastRenewalComment) {
		var ret string
		return ret
	}
	return *o.LastRenewalComment
}

// GetLastRenewalCommentOk returns a tuple with the LastRenewalComment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiPolicyWaiverDTO) GetLastRenewalCommentOk() (*string, bool) {
	if o == nil || IsNil(o.LastRenewalComment) {
		return nil, false
	}
	return o.LastRenewalComment, true
}
...
// SetLastRenewalComment gets a reference to the given string and assigns it to the LastRenewalComment field.
func (o *ApiPolicyWaiverDTO) SetLastRenewalComment(v string) {
	o.LastRenewalComment = &v
}

// GetLastRenewalReasonText returns the LastRenewalReasonText field value if set, zero value otherwise.
func (o *ApiPolicyWaiverDTO) GetLastRenewalReasonText() string {
	if o == nil || IsNil(o.LastRenewalReasonText) {
		var ret string
		return ret
	}
	return *o.LastRenewalReasonText
}

// GetLastRenewalReasonTextOk returns a tuple with the LastRenewalReasonText field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiPolicyWaiverDTO) GetLastRenewalReasonTextOk() (*string, bool) {
	if o == nil || IsNil(o.LastRenewalReasonText) {
		return nil, false
	}
	return o.LastRenewalReasonText, true
}
...
// SetLastRenewalReasonText gets a reference to the given string and assigns it to the LastRenewalReasonText field.
func (o *ApiPolicyWaiverDTO) SetLastRenewalReasonText(v string) {
	o.LastRenewalReasonText = &v
}
...
// GetLastRenewedBy returns the LastRenewedBy field value if set, zero value otherwise.
func (o *ApiPolicyWaiverDTO) GetLastRenewedBy() string {
	if o == nil || IsNil(o.LastRenewedBy) {
		var ret string
		return ret
	}
	return *o.LastRenewedBy
}

// GetLastRenewedByOk returns a tuple with the LastRenewedBy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiPolicyWaiverDTO) GetLastRenewedByOk() (*string, bool) {
	if o == nil || IsNil(o.LastRenewedBy) {
		return nil, false
	}
	return o.LastRenewedBy, true
}
...
// SetLastRenewedBy gets a reference to the given string and assigns it to the LastRenewedBy field.
...
func (o ApiPolicyWaiverDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastRenewalComment) {
		toSerialize["lastRenewalComment"] = o.LastRenewalComment
	}
	if !IsNil(o.LastRenewalReasonText) {
		toSerialize["lastRenewalReasonText"] = o.LastRenewalReasonText
	}
	if !IsNil(o.LastRenewedAt) {
		toSerialize["lastRenewedAt"] = o.LastRenewedAt
	}
	if !IsNil(o.LastRenewedBy) {
		toSerialize["lastRenewedBy"] = o.LastRenewedBy
	}
