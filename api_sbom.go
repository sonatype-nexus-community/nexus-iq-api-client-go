...
func (r ApiGetSbomVersionRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *SBOMAPIService) GetSbomVersionExecute(r ApiGetSbomVersionRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetVulnerabilityDetailsRequest struct {
	ctx context.Context
	ApiService *SBOMAPIService
	applicationId string
	version string
...
// (One of packageUrl or componentHash is required) Enter the packageUrl of the component with the vulnerability
func (r ApiGetVulnerabilityDetailsRequest) PackageUrl(packageUrl string) ApiGetVulnerabilityDetailsRequest {
	r.packageUrl = &packageUrl
	return r
}

// (One of packageUrl or componentHash is required) Enter the componentHash of the component with the vulnerability
func (r ApiGetVulnerabilityDetailsRequest) ComponentHash(componentHash string) ApiGetVulnerabilityDetailsRequest {
	r.componentHash = &componentHash
	return r
}

func (r ApiGetVulnerabilityDetailsRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVulnerabilityDetailsExecute(r)
}

/*
GetVulnerabilityDetails Method for GetVulnerabilityDetails
...
Use this method to retrieve details for a vulnerability belongs to a specific sbom version 
 ...
 @param version The version for a specific SBOM where the vulnerability is present
 @param refId The vulnerability id of a vulnerability
 @return ApiGetVulnerabilityDetailsRequest
*/
func (a *SBOMAPIService) GetVulnerabilityDetails(ctx context.Context, applicationId string, version string, refId string) ApiGetVulnerabilityDetailsRequest {
	return ApiGetVulnerabilityDetailsRequest{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
func (a *SBOMAPIService) GetVulnerabilityDetailsExecute(r ApiGetVulnerabilityDetailsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SBOMAPIService.GetVulnerabilityDetails")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/sbom/applications/{applicationId}/versions/{version}/vulnerability/{refId}"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationId"+"}", url.PathEscape(parameterValueToString(r.applicationId, "applicationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", url.PathEscape(parameterValueToString(r.version, "version")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"refId"+"}", url.PathEscape(parameterValueToString(r.refId, "refId")), -1)
	...
	if r.componentHash != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "componentHash", r.componentHash, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiImportSbomRequest) ApplicationId(applicationId string) ApiImportSbomRequest {
	r.applicationId = &applicationId
	return r
}

// Your SBOM.
func (r ApiImportSbomRequest) File(file *os.File) ApiImportSbomRequest {
	r.file = file
	return r
}
...
// The SBOM version.
func (r ApiImportSbomRequest) ApplicationVersion(applicationVersion string) ApiImportSbomRequest {
	r.applicationVersion = &applicationVersion
	return r
}

func (r ApiImportSbomRequest) Execute() (*ApiThirdPartyScanTicketDTO, *http.Response, error) {
...
func (a *SBOMAPIService) ImportSbomExecute(r ApiImportSbomRequest) (*ApiThirdPartyScanTicketDTO, *http.Response, error) {
	var (
	...
	if r.applicationVersion != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "applicationVersion", r.applicationVersion, "", "")
	}
