...
type ApiGetCurrentUserTokenCreateTimeRequest struct {
	ctx context.Context
	ApiService *UserTokensAPIService
}

func (r ApiGetCurrentUserTokenCreateTimeRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.GetCurrentUserTokenCreateTimeExecute(r)
}

/*
GetCurrentUserTokenCreateTime Method for GetCurrentUserTokenCreateTime
...
Permissions required: None
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCurrentUserTokenCreateTimeRequest
*/
func (a *UserTokensAPIService) GetCurrentUserTokenCreateTime(ctx context.Context) ApiGetCurrentUserTokenCreateTimeRequest {
	return ApiGetCurrentUserTokenCreateTimeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *UserTokensAPIService) GetCurrentUserTokenCreateTimeExecute(r ApiGetCurrentUserTokenCreateTimeRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserTokensAPIService.GetCurrentUserTokenCreateTime")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/userTokens/currentUser/createTime"
