...
// Enter the desired SPDX version, possible values are 2.2|2.3|3.0 (3.0 only supports JSON format)
func (r ApiGetByScanIdRequest) SpdxVersion(spdxVersion string) ApiGetByScanIdRequest {
	r.spdxVersion = &spdxVersion
	return r
}

func (r ApiGetByScanIdRequest) Execute() (string, *http.Response, error) {
...
//  @return string
func (a *SPDXAPIService) GetByScanIdExecute(r ApiGetByScanIdRequest) (string, *http.Response, error) {
	var (
...
func (r ApiGetLatestForStageRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *SPDXAPIService) GetLatestForStageExecute(r ApiGetLatestForStageRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
