...
Export component search results as CSV (streaming). Identifies applications containing components affected by CVE-2025-55182. Results are streamed to avoid memory issues with large datasets. Keep-alive mechanism prevents ALB timeouts during long-running queries. <p>Permissions Required: View IQ Elements
